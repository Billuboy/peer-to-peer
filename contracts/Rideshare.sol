...
contract Rideshare is Killable {
  ...
  function getPassengers(uint rideNumber) public view returns(address[]) {
    return rides[rideNumber].passengerAccts;
  }

  function getPassengerRideState(uint rideNumber, address passenger) public view returns(string) {
